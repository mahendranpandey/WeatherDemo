...
<html lang="en">
    ...
    <div class="container" id="display">
      ...
      <form class="form-signin" role="form" method="post" action="<spring:url value="/logincheck" />">
        ...
        <input type="text" name="pass" id="inputEmail" class="form-control" placeholder="Email" required>
        <label for="inputEmail" class="sr-only">Password</label>
        <input type="password" name="uname" id="inputPassword" class="form-control" placeholder="Password" required>
        <label for="inputPassword"  class="sr-only">Confirm Password</label>
        <input type="password" name="pass" id="inputConfirmPassword" class="form-control" placeholder="Confrim Password" required>
